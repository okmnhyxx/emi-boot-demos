 ...
 ;(function($,window,document){
 	...
 	DialogBox.prototype = {	
 		...
 		create: function(element){
 			...
 			if(!title){
				dialogHTML[0] = '<section class="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><h3>'+ "  " + '</h3><span class="glyphicon glyphicon-remove dialog-box-close"></span></div>' +
 				...
 				if(!hasClose){
					...
					dialogHTML[0] = '<section class="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><h3>'+ title + '</h3><span class="glyphicon glyphicon-remove dialog-box-close"></span></div>' +
						'<div class="dialog-box-content"></div>';
 			...
 			if(!hasBtn){
 				...
 				if(confirmValue && cancelValue){
					...
					dialogHTML[1] = '<div class="dialog-btn"><span class="dialog-btn-confirm">' + confirmValue + '</span></div></div></section>';
 					...
 					dialogHTML[1] = '<div class="dialog-btn"><span class="dialog-btn-confirm" style="width: 150px;">确定</span></div></div></section>';
 				}
 			}
 		...
 		trigger: function(element,event){
 			...
 			$('.dialog-box-close,#dialog-box-mask,.dialog-btn-cancel,.dialog-btn-confirm').on('click',function(e){
 				that.hide($this);
				e.stopPropagation();
 			});
