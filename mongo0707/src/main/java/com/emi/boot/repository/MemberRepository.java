...
//    todo:
//    @Query("select new com.emi.boot.dto.member.vo.MemberVo(m.id, m.phone, m.realName, m.idCard, m.sex, m.deposit, m.balance, m.freezeAmounts, m.validState, true) from Member m " +
