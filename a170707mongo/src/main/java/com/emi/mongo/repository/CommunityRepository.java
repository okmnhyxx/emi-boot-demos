...
public interface CommunityRepository extends MongoRepository<Community, String> {
    ...
    //todo:
//    @Query("select new com.emi.mongo.dto.community.vo.CommunityVo(c.id, c.name, c.buildingNo, c.validState, c.createTime) from Community c " +
...
//    @Query("select new com.emi.mongo.dto.community.vo.CommunityVo(c.id, c.name, c.buildingNo, c.validState) from Community c " +
