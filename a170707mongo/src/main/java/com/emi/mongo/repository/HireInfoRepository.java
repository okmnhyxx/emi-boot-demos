...
public interface HireInfoRepository extends MongoRepository<HireInfo, String> {
    ...
    //todo:
//    @Query("select new com.emi.mongo.vo.HireSqlVo(h.id, h.amounts, h.hired, h.hireTimeStr, h.createTime, h.memberId, h.communityId, h.community, h.carLocationId, h.carLocation) " +
//            " from HireInfo h" +
//            " where h.memberId = ?1 " +
//            " and h.active = true")
